...
def run_hedge_fund(
    ...
    # Hardcoded contract address for BTC-USD pair
    contract_address = "0x2260fac5e5542a773aa44fbcfedf7c193bc2c599"  # BTC-USD WBTC contract
    ...
    final_state = app.invoke(
        {
            ...
            "data": {
                "ticker": ticker,
                "contract_address": contract_address,  # Add contract_address to state
                "portfolio": portfolio,
...
if __name__ == "__main__":
    ...
    result = run_hedge_fund(
        ticker="BTC",  # Keep ticker for reference
        start_date=start_date,
        end_date=end_date,
        portfolio=portfolio,
        show_reasoning=True,
